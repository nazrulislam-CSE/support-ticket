    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu ">
                ...
                <li class="slide {{ Request::is('admin/tickets*') ? 'is-expanded' : '' }}">
                    ...
                    <ul class="slide-menu">
                        ...
                        {{-- <li><a class="slide-item {{ Request::is('admin/ticket/create') ? 'active' : '' }}" href="{{ route('admin.ticket.create')}}">Ticket Add</a></li> --}}
                        <li><a class="slide-item {{ Request::is('admin/ticket/index') ? 'active' : '' }}" href="{{ route('admin.ticket.index')}}">Ticket List</a></li>
                    </ul>
                </li>
            </ul>
