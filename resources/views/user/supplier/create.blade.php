...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-xl-4 col-lg-6 col-md-6">
                            <label for="" class="form-label">{{ __('City / State') }}</label>
                            <div class="input-group">
                                <span class="input-group-text" title="City / State" id="basic-addon1"><i class="fas fa-city" title="Name"></i></span>
                                <input type="text" class="form-control" name="upazilla_thana" placeholder="City / State">
                            </div>
                        </div>
                        <div class="form-group col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="form-group col-xl-4 col-lg-6 col-md-6">
                            <label for="" class="form-label">{{ __('Supplier Group') }}</label>
                            <div class="input-group">
                                ...
                                <a data-bs-target="#supplierGroupModal" data-bs-toggle="modal" class="add-to-cart btn btn-success" type="button" href="javascript:;"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
    ...
    @include('user.supplier.group-modal')
