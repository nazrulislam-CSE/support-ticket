                        ...
                        <table id="file-datatable" class="border-top-0 table table-bordered text-nowrap key-buttons border-bottom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('user.ticket.edit', $ticket->id) }}" class="btn btn-primary btn-sm mr-2"><i class="fas fa-edit"></i></a>
                                        <a href="{{ route('user.ticket.delete', $ticket->id) }}"  class="btn btn-danger btn-sm" title="Delete Ticket" id="delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
